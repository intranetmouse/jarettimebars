...
import de.jaret.examples.timebars.fzd.model.FzdModel;
...
public class FzdExample {
    public static void main(String[] args) {
        ...
        // fahrzeuge
        ZuteilungsModel model = FzdModel.createFzdModel(10, 30, 24, 5);
        ...
        Action action = new AssignAction(FzdModel._ukettenModel, tbv, tbv2);
