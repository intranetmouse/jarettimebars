 ...
 */
public class PerfExample extends ApplicationWindow {
    ...
    protected Control createContents(Composite parent) {
        ...
        PerfControlPanel ctrl = new PerfControlPanel(parent, SWT.NULL, _tbv);
    ...
    public static void main(String[] args) {
        PerfExample test = new PerfExample();
