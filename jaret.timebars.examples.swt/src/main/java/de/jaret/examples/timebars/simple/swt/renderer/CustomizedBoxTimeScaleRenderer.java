/*
 *  File: CustomizedBoxTimeScaleRenderer.java 
 ...
 * 
 * @author Peter Kliem
 * @version $Id: BoxTimeScaleRenderer.java 1086 2011-07-30 20:28:05Z kliem $
 */
public class CustomizedBoxTimeScaleRenderer extends RendererBase implements TimeScaleRenderer, ITickProvider {
    /** default number of strips to render. */
    private static final int DEFAULT_NUMBER_OF_STRIPS = 4;
     ...
     */
    public CustomizedBoxTimeScaleRenderer(Printer printer) {
        super(printer);
        initIterators();
    }
    ...
    private void initIterators() {
        ...
        DateIterator di = new WeekIterator(); 
        di.setFormatter(new IIteratorFormatter() {
            
            @Override
            public String getLabel(JaretDate date, Format format) {
                    return "W "+Integer.toString(date.getWeekOfYear());
            }
        });
        _iterators.add(di);
        _formats.add(DateIterator.Format.LONG);
     ...
     * Default constructor.
     */
    public CustomizedBoxTimeScaleRenderer() {
        super(null);
        initIterators();
    }
    ...
    public TimeScaleRenderer createPrintRenderer(Printer printer) {
        return new CustomizedBoxTimeScaleRenderer(printer);
    }
